...
- Python 파일을 수정한 뒤 필요한 `TODO.md`, `NOTES.md`, `README.md`, `PROJECT_PLAN.md`, `AGENTS.md` 반영은 확인 질문 없이 수행합니다.
...
- 사용자가 커밋/푸쉬까지 요청한 작업은 필요한 파일만 staging한 뒤 커밋하고 push합니다.
- 커밋/푸쉬 요청이 없는 작업은 사용자 승인 후에만 커밋합니다.
